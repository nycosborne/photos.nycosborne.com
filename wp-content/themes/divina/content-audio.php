<?php
/**
 * The default template for displaying post format audio content
 *
 * @package Divina
 */
...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<header class="entry-header">
		...
		<div class="divina-divider"><a href="<?php echo esc_url( get_post_format_link( 'audio' ) ); ?>"><span class="divina-post-format glyphicon glyphicon-music" aria-hidden="true"></span></a></div>
	</header><!-- .entry-header -->
