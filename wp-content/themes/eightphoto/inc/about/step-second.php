...
add_thickbox();
$eightphoto_recommended_plugins = array(
	'8-degree-coming-soon-page' => array( 'recommended' => false ),
	'accesspress-instagram-feed' => array('recommended' => true),
	...
	'newsletter'  => array( 'recommended' => false ),
	);
	?>
	<div class="feature-section recommended-plugins">
		<?php foreach ( $eightphoto_recommended_plugins as $plugin => $prop ) { ?>
		<?php
		...
		switch ( $active['needs'] ) {
			...
			$label = __( 'Install', 'eightphoto' );
			break;
			case 'activate':
			$class = 'activate-now button button-primary';
			$label = __( 'Activate', 'eightphoto' );
			break;
			case 'deactivate':
			$class = 'deactivate-now button';
			$label = __( 'Deactivate', 'eightphoto' );
			break;
		}
		...
		<div class="col plugin_box">
			<?php if ( $prop['recommended'] ): ?>
				<span class="recommended"><?php _e( 'Highly', 'eightphoto' ); ?></span>
			<?php endif; ?>
			...
			<div class="b-wrap">
			<span class="version"><?php echo __( 'Version:', 'eightphoto' ); ?><?php echo esc_html( $info->version ) ?></span>
