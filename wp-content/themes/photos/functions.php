...
function photos_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'photos' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'photos' ),
...
function photos_scripts() {
	...
	wp_enqueue_script( 'photos-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );
